...
export default function Navbar() {
    ...
    return (
        <nav className="border-b bg-blue-50/60 dark:bg-gray-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16 items-center">
                    ...
                    <div className="hidden md:flex md:items-center md:gap-6">
                        {companyDetails.routes.map((route) => (
                            <Link 
                                key={route.path}
                                href={route.path} 
                                className="text-sm font-medium hover:text-indigo-600 hover:dark:text-blue-200 transition-colors duration-300 relative group"
                            >
                    ...
                    <div className="flex items-center gap-3">
                        <ThemeToggle />
                        <Button className="bg-transparent text-black dark:text-white hover:bg-blue-50 hover:dark:bg-blue-50/5 rounded-sm hover:dark:text-blue-200 transition-colors duration-300 hover:shadow-[0_0_15px_rgba(59,130,246,0.5)]">
                            <Link href="/signup">
                                Sign up
                            </Link>
                        </Button>
                        <Button className="bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 rounded-sm shadow-lg hover:shadow-[0_0_20px_rgba(99,102,241,0.7)] transition-all duration-300 transform hover:-translate-y-0.5">
                            <Link href="/try">
                                Try it free
                            </Link>
                        </Button>
